export default {
  ...
  requestLogs: {
    title: 'Request Logs',
    description: 'Browse request metadata and inspect individual request records',
    detailTitle: 'Request Log Detail',
    detailDescription: 'Inspect request metadata for a single API call',
    pageSummary: 'Current filter result size',
    currentPageCount: 'Items on this page',
    successCount: 'Success',
    errorCount: 'Errors',
    noRecords: 'No request logs found. Try adjusting your filters.',
    failedToLoad: 'Failed to load request logs',
    failedToLoadDetail: 'Failed to load request log detail',
    ...
    backToList: 'Back to Request Logs',
