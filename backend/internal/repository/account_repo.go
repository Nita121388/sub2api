...
func (r *accountRepository) ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, accountType, status, search string, groupID int64, schedulable *bool) ([]service.Account, *pagination.PaginationResult, error) {
	...
	if schedulable != nil {
		q = q.Where(dbaccount.SchedulableEQ(*schedulable))
	}
