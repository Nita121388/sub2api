export default {
  ...
  requestLogs: {
    ...
    description: 'Browse session metadata and inspect individual session details',
    detailTitle: 'Session Detail',
    detailDescription: 'Inspect session details for a single API call',
    pageSummary: 'Current filter result size',
    currentPageCount: 'Items on this page',
    successCount: 'Success',
    errorCount: 'Errors',
    noRecords: 'No session records found. Try adjusting your filters.',
    failedToLoad: 'Failed to load session details',
    failedToLoadDetail: 'Failed to load session detail',
    invalidStatusCode: 'Status code must be a valid number',
    apiKey: 'API Key',
    apiKeyFilter: 'API Key',
    allApiKeys: 'All API Keys',
    model: 'Model',
    ...
    visualizedContent: 'Session Viewer',
    visualizedDescription: 'Parsed conversation blocks first, raw payloads below for fallback and debugging.',
    sessionTimeline: 'Session Timeline',
    sessionTimelineDescription: 'Request and response blocks are merged into a single conversation flow.',
    turnCount: '{count} turns',
    stepCount: '{count} steps',
    turnStepSummary: '{count} entries',
    requestConversation: 'Request Blocks',
    responseConversation: 'Response Blocks',
    noConversationBlocks: 'No structured conversation blocks were found. Check the raw payloads below.',
    ...
    media: 'Media',
    bodyBytes: 'Original Bytes',
    truncated: 'Truncated',
    payloadUnavailable: 'No payload captured',
    errorInfo: 'Error Info',
    errorCode: 'Error Code',
    errorMessage: 'Error Message',
    backToList: 'Back to Session Details',
  ...
  admin: {
    ...
    dashboard: {
      ...
      spendingRankingCollapse: 'Collapse Ranking',
      spendingRankingExpand: 'Expand Ranking',
      spendingRankingCollapsed: 'Spending ranking is hidden. Expand to view details.',
      spendingRankingPrevious: 'Previous',
      spendingRankingNext: 'Next',
      spendingRankingPageInfo: 'Page {page} / {total}',
      spendShort: 'Spend',
      requestsShort: 'Req',
      tokensShort: 'Tok',
    ...
    accounts: {
      ...
      appendModelMapping: {
        action: 'Append Model Whitelist',
        title: 'Append Model Whitelist',
        modelFamily: 'Model Family',
        modelFamilyPlaceholder: 'e.g. gpt-5.6',
        generatePreset: 'Generate Common Mappings',
        requestModel: 'Request Model',
        targetModel: 'Upstream Model',
        requestModelPlaceholder: 'gpt-5.6-high',
        targetModelPlaceholder: 'Use request model when empty',
        addRow: 'Add Row',
        scopeSelected: 'Selected Accounts ({count})',
        scopeSelectedHint: 'Update only the currently selected accounts.',
        scopeAll: 'All OpenAI Accounts',
        scopeAllHint: 'Update OpenAI accounts that already have model whitelists.',
        onlyExisting: 'Only update accounts with existing model_mapping',
        overwriteExisting: 'Allow overwriting conflicting mappings',
        changed: 'Changed',
        skipped: 'Skipped',
        conflicted: 'Conflicts',
        moreResults: '{count} more results hidden',
        preview: 'Preview',
        apply: 'Apply Append',
        emptyMappings: 'Enter at least one model mapping',
        noSelectedAccounts: 'Select accounts first, or switch to all OpenAI accounts',
        previewFailed: 'Preview failed',
        applySuccess: 'Updated {count} accounts',
        applyFailed: 'Apply failed',
        resultChanged: 'Update {count}',
        resultConflict: '{count} conflicts',
        resultUnchanged: 'No change',
        reason: {
          skipped: 'Skipped',
          no_model_mapping: 'No whitelist',
          not_found: 'Not found',
      ...
      overview: {
        ...
        spendCollapsed: 'Leaderboard is collapsed. Use the top-right button to expand.',
      ...
      quickTestTooltip: 'Quick test with {model}',
      quickTestTooltipUnset: 'Set a quick-test model before running',
      quickTestConfigureAction: 'Set quick test model',
      quickTestSetupTitle: 'Quick Test Model',
      quickTestSetupDescription: 'Choose a default model to run account tests instantly.',
      quickTestSetupDescriptionSet: 'Current quick test model: {model}. Select a new one to update.',
      quickTestSetupLabel: 'Default quick test model',
      quickTestSetupPlaceholder: 'Select a model',
      quickTestSetupLoading: 'Loading available models...',
      quickTestSetupEmpty: 'This account has no available models for testing.',
      quickTestSetupSave: 'Save Default',
      quickTestSaved: 'Quick test model set to {model}.',
      quickTestSelectModelHint: 'Please select a test model first.',
      quickTestLoadModelsFailed: 'Failed to load models for quick test.',
      quickTestPresetMissing: 'Saved quick test model is unavailable. Please select a new one.',
      account: 'Account',
