...
const userNavItems = computed((): NavItem[] => {
  const items: NavItem[] = [
    ...
    { path: '/request-logs', label: t('nav.requestLogs'), icon: ChartIcon, hideInSimpleMode: true },
    { path: '/chat-test', label: t('nav.chatTest'), icon: ChartIcon, hideInSimpleMode: true },
