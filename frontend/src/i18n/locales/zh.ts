export default {
  ...
  requestLogs: {
    title: '会话详情',
    description: '查看会话元数据并进入单条会话详情',
    detailTitle: '会话详情',
    detailDescription: '查看单次 API 调用的会话详情',
    pageSummary: '当前筛选结果总量',
    currentPageCount: '本页条数',
    successCount: '成功',
    errorCount: '错误',
    noRecords: '未找到会话记录，请尝试调整筛选条件。',
    failedToLoad: '加载会话详情失败',
    failedToLoadDetail: '加载会话详情失败',
    invalidStatusCode: '状态码必须是有效数字',
    apiKey: 'API 密钥',
    apiKeyFilter: 'API 密钥',
    allApiKeys: '全部密钥',
    model: '模型',
    ...
    requestBody: '请求正文',
    responseBody: '响应正文',
    visualizedContent: '会话视图',
    visualizedDescription: '优先展示解析后的对话内容，下面保留原始 JSON 便于排障。',
    sessionTimeline: '会话时间线',
    sessionTimelineDescription: '将请求和响应内容合并为一条连续的会话流。',
    turnCount: '{count} 个回合',
    stepCount: '{count} 个步骤',
    turnStepSummary: '{count} 个条目',
    requestConversation: '请求块',
    responseConversation: '响应块',
    noConversationBlocks: '未识别到结构化对话内容，请查看下方原始正文。',
    sourceRequest: '请求',
    sourceResponse: '响应',
    sourceMerged: '合并',
    protocolUnknown: '未知',
    ...
    developerPromptTitle: '开发者提示词',
    userMessageTitle: '用户消息',
    assistantReplyTitle: '助手回复',
    assistantDraftTitle: '助手上下文',
    toolCallTitle: '工具调用',
    toolResultTitle: '工具结果',
    turnWithUserMessage: '对话回合',
    toolCall: '工具调用',
    toolName: '工具名',
    toolArguments: '参数',
    toolOutput: '输出',
  ...
  admin: {
    ...
    dashboard: {
      ...
      spendingRankingCollapse: '收起消费榜',
      spendingRankingExpand: '展开消费榜',
      spendingRankingCollapsed: '消费榜已折叠，点击上方按钮展开查看。',
      spendingRankingPrevious: '上一页',
      spendingRankingNext: '下一页',
      spendingRankingPageInfo: '第 {page} / {total} 页',
      spendShort: '消费',
      requestsShort: '请求',
      tokensShort: 'Token',
      last7Days: '近 7 天',
    ...
    accounts: {
      ...
      appendModelMapping: {
        ...
        title: '追加模型白名单',
        modelFamily: '模型族',
        modelFamilyPlaceholder: '例如：gpt-5.6',
        generatePreset: '生成常用映射',
        requestModel: '请求模型',
        targetModel: '实际转发模型',
        requestModelPlaceholder: 'gpt-5.6-high',
        targetModelPlaceholder: '留空则使用请求模型',
        addRow: '添加一行',
        scopeSelected: '选中账号（{count}）',
        scopeSelectedHint: '只更新当前已勾选的账号。',
        scopeAll: '全部 OpenAI 账号',
        scopeAllHint: '更新所有 OpenAI 账号中已有白名单的账号。',
        onlyExisting: '只更新已有 model_mapping 的账号',
        overwriteExisting: '允许覆盖已有冲突映射',
        changed: '将更新',
        skipped: '跳过',
        conflicted: '冲突',
        moreResults: '还有 {count} 条结果未显示',
        preview: '预览',
        apply: '执行追加',
        emptyMappings: '请至少填写一个模型映射',
        noSelectedAccounts: '请先选择账号，或切换到全部 OpenAI 账号',
        previewFailed: '预览失败',
        applySuccess: '已更新 {count} 个账号',
        applyFailed: '执行失败',
        resultChanged: '更新 {count} 项',
        resultConflict: '冲突 {count} 项',
        resultUnchanged: '无需变更',
        reason: {
          skipped: '已跳过',
          no_model_mapping: '无白名单',
          not_found: '账号不存在',
      ...
      overview: {
        ...
        spendCollapse: '收起消费榜',
        spendExpand: '展开消费榜',
        spendCollapsed: '消费榜已折叠，点击右上角按钮展开查看。',
      ...
      quickTest: '快速测试',
      quickTestTooltip: '使用 {model} 快速测试',
      quickTestTooltipUnset: '请先设置快速测试模型',
      quickTestConfigureAction: '设置快速测试模型',
      quickTestSetupTitle: '快速测试模型',
      quickTestSetupDescription: '选择一个默认模型，之后即可一键快速测试账号。',
      quickTestSetupDescriptionSet: '当前快速测试模型：{model}，可在此更新。',
      quickTestSetupLabel: '默认快速测试模型',
      quickTestSetupPlaceholder: '请选择模型',
      quickTestSetupLoading: '正在加载模型…',
      quickTestSetupEmpty: '该账号暂无可测试的模型。',
      quickTestSetupSave: '保存默认模型',
      quickTestSaved: '快速测试模型已更新为 {model}。',
      quickTestSelectModelHint: '请先选择要测试的模型。',
      quickTestLoadModelsFailed: '快速测试模型加载失败。',
      quickTestPresetMissing: '已保存的快速测试模型不可用，请重新设置。',
      account: '账号',
