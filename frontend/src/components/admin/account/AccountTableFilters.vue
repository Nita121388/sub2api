<template>
  <div class="flex flex-wrap items-center gap-3">
    ...
    <Select :model-value="filters.schedulable" class="w-40" :options="scOpts" @update:model-value="updateSchedulable" @change="$emit('change')" />
...
const scOpts = computed(() => [{ value: '', label: t('admin.accounts.allSchedulable') }, { value: 'true', label: t('admin.accounts.schedulableEnabled') }, { value: 'false', label: t('admin.accounts.schedulableDisabled') }])
